...
namespace CyberSecurityGUI.Forms
{
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            AddMessage("🤖 CyberBot", "Welcome to the Cybersecurity Awareness Assistant! I'm here to help you stay safe online.", true);
            AddMessage("🤖 CyberBot", "You can:\n• Ask cybersecurity questions\n• Add/view tasks\n• Take a quiz\n• Type 'help' to see all commands", true);
            AddMessage("🤖 CyberBot", "What would you like to do today?", true);
        ...
        private void ShowReminderDialog(string taskTitle)
        {
