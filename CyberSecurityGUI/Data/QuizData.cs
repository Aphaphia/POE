            ...
            return new List<QuizQuestion>
            {
                new QuizQuestion
                {
                    ...
                    Options = new List<string> {
                        "Your birthdate",
                        "A 12-character mix of letters, numbers, and symbols",
                        "Your pet's name",
                        "Password123"
                    },
                ...
                new QuizQuestion
                {
                    ...
                    Options = new List<string> {
                        "A type of virus that encrypts files",
                        "A security software",
                        "A password manager",
                        "A web browser"
                    },
                ...
                new QuizQuestion
                {
                    ...
                    Options = new List<string> {
                        "3 copies, 2 different storage types, 1 offsite copy",
                        "3 backups, 2 days, 1 week",
                        "3 files, 2 folders, 1 drive",
